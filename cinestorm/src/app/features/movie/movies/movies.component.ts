...
import { IonHeader, IonContent, IonBackButton, IonList, IonThumbnail, IonItem, IonLabel, NavController, SearchbarCustomEvent, IonSearchbar, IonButton } from "@ionic/angular";
...
@Component({
  ...
  imports: [IonHeader, IonContent, IonBackButton, IonList, IonThumbnail, IonItem, IonLabel, IonSearchbar,IonButton],
})
